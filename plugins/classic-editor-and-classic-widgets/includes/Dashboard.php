	...
	public function plugin_action_links( $links ) {
		...
		if ( ! cew_pro_enabled() ) {
			$pro_link = sprintf(
				...
				esc_url( 'https://wpgrim.com/classic-editor-and-classic-widgets-pro/?utm_source=cew-plugin&utm_medium=plugin-action-link&utm_campaign=cew' ),
				esc_html__( 'Get Pro Version', 'classic-editor-and-classic-widgets' )
			);
